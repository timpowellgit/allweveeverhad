...
IMG_DIR = '/Users/greg/Desktop/newmomentstests'
...
print 'starting pool'
p = Pool(7)
descriptor_values = zip(img_paths[:DEBUG_MAX_IMGS], map(get_zernike_vector, tqdm(img_paths[:DEBUG_MAX_IMGS])))
...
# needle_filepath = "aFQTi3Vr5-ggyWcSxKF-eg.jpg"
needle_filepath = "comp1img012.jpg"
