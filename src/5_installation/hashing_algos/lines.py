...
def get_hough_line_vectors(image_path):
  ...
  # anti aliasing and mode set to skimage default/constants
  # simply to not get warning messages to console
  img = resize(img, (512,512), anti_aliasing=False, mode='constant')
